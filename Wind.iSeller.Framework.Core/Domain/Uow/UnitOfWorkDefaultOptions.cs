...
namespace Wind.iSeller.Framework.Core.Domain.Uow
{
    internal class UnitOfWorkDefaultOptions : IUnitOfWorkDefaultOptions
    {
        ...
        public IList<DataFilterConfiguration> Filters { get { return this._filters; } }

        public List<Func<Type, bool>> ConventionalUowSelectors { get; private set; }
        ...
        public void RegisterFilter(string filterName, bool isEnabledByDefault)
        {
            ...
            {
                throw new WindException("There is already a filter with name: " + filterName);
            }
