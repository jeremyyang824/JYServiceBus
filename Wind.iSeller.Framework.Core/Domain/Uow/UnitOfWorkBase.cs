...
namespace Wind.iSeller.Framework.Core.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <inheritdoc/>
        public IList<DataFilterConfiguration> Filters
        {
        ...
        protected IUnitOfWorkFilterExecuter FilterExecuter { get; private set; }
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new WindException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new WindException("Complete is called before!");
            }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new WindException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
            return filter;
        }
