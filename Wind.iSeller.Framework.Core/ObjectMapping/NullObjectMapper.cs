...
namespace Wind.iSeller.Framework.Core.ObjectMapping
{
    public sealed class NullObjectMapper : IObjectMapper, ISingletonDependency
    {
        ...
        {
            throw new WindException("Wind.iSeller.Framework.Core.ObjectMapping.IObjectMapper should be implemented in order to map objects.");
        }
